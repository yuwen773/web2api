...
**P0 - 必须先完成**：
1. 步骤 1.9：全局并发限制（防止太极AI过载）
2. 步骤 2.1：FastAPI 框架搭建

**P1 - 阶段 2 核心**：
3. 步骤 2.2：OpenAI 请求/响应模型
4. 步骤 2.3：`/v1/chat/completions`（非流式）
5. 步骤 2.4：`/v1/chat/completions`（流式）
